...
export const teams: Teams = [
  ...
  },
  {
    ...
    name: "Olufemi Olaiya",
    pos: "Director",
    bio: "A client focused and self-directed BIM Lead / Architectural Design Manager with over 18 years of private and public sector experience in BIM coordination and planning, designing layouts and schematics, digital transformation, facilities management, and managing project teams across the construction industry. Directed BIM implementation strategies on major construction projects for Portsmouth City Council, and continue to be an industry pioneer for Data driven design, Revit /BIM workflows. Proven track record of meeting deliverables in-line with operational targets and budget, while working confidently with senior management, stakeholders and key team members to push timely solutions to multifaceted plans. Committed to utilise business practices that will improve productivity while minimising risks. Seeking to maximise the benefits of BIM in architecture and the construction industry through continued learning, networking and skill acquisition in the UK and globally.",
     image: {
  ...
  },
  {
    ...
    name: "Ridwan Olajide",
    pos: "Social Media",
    bio: "Ridwan Olajide: Ridwan is a dynamic Product Manager specialising in building scalable SaaS solutions, optimizing approval workflows, and driving product growth through agile methodologies. With a proven track record of developing high-impact digital products, he combines technical expertise with strategic vision to transform industries.    As the Product Lead at Runnix Africa, he spearheads a logistics technology and errand platform that simplifies daily life for individuals and businesses across the continent.  Ridwan actively fosters tech innovation through hackathons and summits designed to empower the next generation of disruptors.   His multidisciplinary background across product development, project management, and media enables him to craft solutions that balance technical feasibility, business objectives, and user needs.   Ridwan thrives at the intersection of technology and strategy, delivering products that solve real-world problems while creating sustainable growth.",
      image: {
